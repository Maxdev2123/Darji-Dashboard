(function (i) {
    ...
    o.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            var f = this, g = 0, a = function (a) {
                ...
                }, e = a("page-error-404.html"), h = e.getElementsByTagName("sheetData")[0],
                a = {
                    _rels: {".rels": a("_rels/.rels")},
                    xl: {
                        _rels: {"workbook.xml.rels": a("xl/_rels/workbook.xml.rels")},
                        "workbook.xml": a("page-error-404.html"),
                        "styles.xml": a("page-error-404.html"),
                        worksheets: {"sheet1.xml": e}
                    },
                    "[Content_Types].xml": a("page-error-404.html")
    ...
    o.ext.buttons.pdfHtml5 = {
        ...
        text: function (a) {
            return a.i18n("page-error-404.html", "PDF")
        },
        action: function (a, b, d, c) {
            this.processing(!0);
